...
def main():
    """The primary program entrypoint.

    Parse the command line arguments, execute the appropriate action,
    and exit reporting status.
    """
    args = get_argument_parser().parse_args()

    bundle = kbundle.bundle.Bundle(args.root)
